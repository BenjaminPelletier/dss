...
local make_resources(dss_instances, db_type) = {
...
local make_artifacts(test_name, dss_instances, db_type) = [
  {
    raw_report: {
...

{
  ...
  shape: shape,
  actions: actions,
  make_resources: make_resources,
  make_user_types: make_user_types,
  make_loads: make_loads,
  make_scenarios: make_scenarios,
